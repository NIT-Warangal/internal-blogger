...
<body class="wp-core-ui">
	<h1 id="logo"><a href="https://github.org/NIT-Warangal/">Blog</a></h1>
	<h2>Error: PHP is not running</h2>
	<p>This Blog setup requires that your web server is running PHP. Your server does not have PHP installed, or PHP is turned off.</p>
</body>
</html>
<?php
}
...
<form id="setup" method="post" action="install.php?step=2">
	...
	<p class="step"><input type="submit" name="Submit" value="<?php esc_attr_e( 'Install Student Council Blog' ); ?>" class="button button-large" /></p>
</form>
<?php
...
<p><?php printf( __( 'Welcome to the five minute NIT Student Council blog installation process!  Just fill in the information below and you&#8217;ll be on your way to set this up / contribute back.' )); ?></p>
...
<p><?php _e( 'Student Council Blog has been installed. Were you expecting more steps? Sorry to disappoint.' ); ?></p>
